...
describe("loadSnapshots", () => {
  ...
  it("loads valid snapshots sorted by date", () => {
    ...
    expect(
      new Date(snaps[0].generatedAt) < new Date(snaps[1].generatedAt),
    ).toBe(true);
  });
...
describe("extractTrends", () => {
    ...
    const snaps = [
      {
        generatedAt: "2026-03-01T10:00:00Z",
        data: {
          stories: [{ status: "Done" }, { status: "In Progress" }],
          costs: {},
          coverage: {},
        },
      },
      {
        generatedAt: "2026-03-02T10:00:00Z",
        data: {
          stories: [{ status: "Done" }, { status: "Done" }],
          costs: {},
          coverage: {},
        },
      },
  ...
  it("extracts total story counts", () => {
    const snaps = [
      {
        generatedAt: "2026-03-01T10:00:00Z",
        data: { stories: [{ status: "Done" }], costs: {}, coverage: {} },
      },
      {
        generatedAt: "2026-03-02T10:00:00Z",
        data: {
          stories: [{ status: "Done" }, { status: "Planned" }],
          costs: {},
          coverage: {},
        },
      },
  ...
  it("extracts AI costs", () => {
    const snaps = [
      ...
      },
      {
        ...
        data: {
          stories: [],
          costs: { "US-0001": { costUsd: 10.5 }, "US-0002": { costUsd: 5.25 } },
          coverage: {},
        },
      },
    ];
    ...
    const snaps = [
      {
        ...
        data: {
          stories: [],
          costs: {},
          coverage: { available: true, overall: 95.5 },
        },
      },
      {
        generatedAt: "2026-03-02T10:00:00Z",
        data: {
          stories: [],
          costs: {},
          coverage: { available: true, overall: 96.0 },
        },
      },
    ];
    const trends = extractTrends(snaps);
    ...
    const snaps = [
      ...
      },
      {
        ...
        data: {
          stories: [],
          costs: {},
          coverage: { available: true, overall: 96 },
        },
      },
    ];
    const trends = extractTrends(snaps);
    ...
    const snaps = [
      {
        generatedAt: "2026-03-01T10:00:00Z",
        data: {
          stories: [{ status: "Done", estimate: "M" }],
          costs: {},
          coverage: {},
        },
      },
  ...
  it("extracts open bugs count", () => {
    const snaps = [
      ...
      },
      {
        ...
        data: {
          stories: [],
          bugs: [{ status: "Open" }, { status: "In Progress" }],
          costs: {},
          coverage: {},
        },
      },
    ...
    const snaps = [
      {
        generatedAt: "2026-03-01T10:00:00Z",
        data: {
          stories: [{ atRisk: true }, { atRisk: false }],
          bugs: [],
          costs: {},
          coverage: {},
        },
      },
      {
        generatedAt: "2026-03-02T10:00:00Z",
        data: {
          stories: [{ atRisk: true }, { atRisk: true }],
          bugs: [],
          costs: {},
          coverage: {},
        },
    ...
    const snaps = [
      {
        ...
        data: {
          stories: [],
          costs: { "US-0001": { inputTokens: 1000, outputTokens: 500 } },
          coverage: {},
        },
      },
      {
