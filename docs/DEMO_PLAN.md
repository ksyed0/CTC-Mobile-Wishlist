...
> "Let me switch to the simulator mode — it's actually a feature we built specifically for demo scenarios like this." _(switch to Scan tab on simulator)_
