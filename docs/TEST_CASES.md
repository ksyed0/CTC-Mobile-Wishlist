...
TC-0001: App launches on iOS and Android
...
TC-0006: Category filter chips filter product list
...
TC-0013: Camera opens with barcode overlay on Scan tab
...
TC-0017: Wishlists tab shows all wishlists with item count
...
TC-0024: Share button opens contact picker
...
TC-0033: Mock login screen with user profiles
