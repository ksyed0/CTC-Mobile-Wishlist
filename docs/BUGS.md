...
### BUG-001: AsyncStorage key schema conflict between docs

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-001
...
### BUG-002: Palette agent never spawned in orchestration playbook

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-002
...
### BUG-003: No phase exit criteria defined for Conductor

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-003
...
### BUG-004: Vague error handling and escalation rules

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-004
...
### BUG-005: Lens Phase 5 review scope undefined

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-005
...
### BUG-006: AC ownership conflict between PO and Tester

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-006
...
### BUG-007: Free-form context passing between agents

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-007
...
### BUG-008: 4 acceptance criteria lack test cases

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-008
- **Found in:** `docs/TEST_CASES.md`
- **Description:** AC-001-001-004 (splash screen), AC-001-002-002 (bundled images), AC-001-002-003 (mock users), AC-002-003-001 (search bar visibility) have no corresponding test cases.
- **Fix:** P1.3 — Add TC-001-001-004 through TC-002-003-002.

### BUG-009: No single source of truth for real vs simulated features

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-009
...
### BUG-010: ROLLBACK.md referenced but empty

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-010
...
### BUG-011: No cross-link between SDLC dashboard and Plan Visualizer

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-011
...
### BUG-012: No device compatibility section in design system

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-012
...
### BUG-013: No deployment strategy documented

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-013
...
### BUG-014: Dashboard is dark-mode only with low contrast text

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-014
...
### BUG-015: Dashboard references EliteA instead of Claude Code

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-015
...
### BUG-016: Unused `spin` CSS keyframe in dashboard

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-016
...
### BUG-017: No convenience `build` script in package.json

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-017
...
### BUG-018: No pre-phase file verification in orchestration

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-018
- **Found in:** `docs/agents/DM_AGENT.md`
...
### BUG-020: Story priorities duplicated in PO_AGENT.md and AGENT_PLAN.md

- **Severity:** Minor
- **Status:** Won't Fix (acceptable duplication for agent isolation)
- **Fix Branch:** est/BUG-020
...
### BUG-021: Branch naming convention stated 5+ times

- **Severity:** Minor
- **Status:** Won't Fix (acceptable duplication for agent isolation)
- **Fix Branch:** est/BUG-021
...
### BUG-022: No hover states on dashboard interactive elements

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-022
- **Found in:** `tools/generate-dashboard.js`
...
### BUG-023: Dashboard has no responsive layout for phones/tablets

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-023
- **Found in:** `tools/generate-dashboard.js`
...
### BUG-024: Dashboard has no About section or attribution

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-024
- **Found in:** `tools/generate-dashboard.js`
...
### BUG-025: No retry state tracking for Conductor

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-025
- **Found in:** `docs/agents/DM_AGENT.md`
...
### BUG-026: "Escalate to human" workflow undefined

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-026
...
### BUG-027: No BLOCK recovery protocol

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-027
...
### BUG-028: No parallel agent failure coordination rules

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-028
- **Found in:** `docs/agents/DM_AGENT.md`
...
### BUG-029: No hard phase timeout

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-029
...
### BUG-030: No BLOCK vs REQUEST CHANGES threshold criteria for Lens

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-030
...
### BUG-031: Agentic orchestration is coupled to Claude Code platform

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-031
...
### BUG-032: No CI checks on pull requests

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-032
...
### BUG-033: ESLint not covering orchestrator/ or tests/ files

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-033
...
### BUG-034: Unused imports in orchestrator/spawn.js

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-034
...
### BUG-035: Useless assignment in generate-dashboard.js

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-035
...
### BUG-036: Error cause not preserved in generate-plan.js

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-036
...
### BUG-037: No code formatting standard enforced

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-037
...
### BUG-038: Dashboard does not render BLOCKED phase status

- **Severity:** High
- **Status:** Fixed
- **Fix Branch:** est/BUG-038
...
### BUG-039: Dashboard does not render BLOCKED agent status

- **Severity:** High
- **Status:** Fixed
- **Fix Branch:** est/BUG-039
...
### BUG-040: No alert banner when orchestration is BLOCKED

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-040
- **Found in:** `tools/generate-dashboard.js`
...
### BUG-041: No audio alert on BLOCK events

- **Severity:** High
- **Status:** Fixed
- **Fix Branch:** est/BUG-041
- **Found in:** `tools/generate-dashboard.js`
...
### BUG-042: No browser notification on BLOCK events

- **Severity:** High
- **Status:** Fixed
- **Fix Branch:** est/BUG-042
- **Found in:** `tools/generate-dashboard.js`
...
### BUG-043: Prettier reformats test fixture breaking parse-bugs tests

- **Severity:** Medium
- **Status:** Fixed
- **Fix Branch:** est/BUG-043
...
### BUG-044: Race condition on sdlc-status.json during parallel agent writes

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-044
...
### BUG-045: Race condition on ID_REGISTRY.md causes duplicate IDs

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-045
...
### BUG-046: Interleaved writes to progress.md and AI_COST_LOG.md

- **Severity:** High
- **Status:** Fixed
- **Fix Branch:** est/BUG-046
...
### BUG-047: Git push failures during parallel agent branches

- **Severity:** High
- **Status:** Fixed
- **Fix Branch:** est/BUG-047
...
### BUG-048: No merge conflict detection before parallel branch merges

- **Severity:** High
- **Status:** Fixed
- **Fix Branch:** est/BUG-048
- **Found in:** `docs/agents/DM_AGENT.md`
...
### BUG-049: No pre-commit formatting enforcement

- **Severity:** Medium
- **Status:** Fixed
- **Fix Branch:** est/BUG-049
...
### BUG-050: Agent registry hardcoded across 3 files

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-050
...
### BUG-051: DM_AGENT.md says "7 sub-agents" but there are 8

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-051
...
### BUG-052: Agent instruction files contain project-specific content

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-052
- **Found in:** All 9 files in `docs/agents/`
- **Description:** All agent instruction files contained hardcoded project-specific content: user story IDs (US-001-001–US-006-001), screen names (CatalogScreen, WishlistsScreen), service names (ProductService, WishlistService), branch names (feature/US-001-001-expo-scaffold), design tokens (#D52B1E), mock data specs, and feature names (barcode, wishlist, catalog). This made the agent framework non-portable — using it on a different project required rewriting all 9 files.
...
### BUG-053: No project entry point for multi-platform agent discovery

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-053
...
### BUG-054: Dashboard title, footer, brand color, and repo URL hardcoded

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-054
...
### BUG-055: XSS via unescaped data attributes in render-html.js

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-055
...
### BUG-056: Command injection via unquoted branch names in git-safe.js

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-056
...
### BUG-057: Infinite recursion in stale lock recovery (file-lock.js)

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-057
...
### BUG-058: Race condition on temp file names in atomic-write.js

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-058
...
### BUG-059: Missing JSON parse error handling in atomic-write.js

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-059
...
### BUG-060: Missing JSON parse error handling in spawn.js

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-060
...
### BUG-061: Missing argument bounds checking in spawn.js CLI

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-061
...
### BUG-062: Silent lock directory removal failure in file-lock.js

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-062
...
### BUG-063: Dashboard author info hardcoded in generate-dashboard.js

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-063
...
### BUG-064: Hardcoded agent count (9) in process-avatars.js

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-064
...
### BUG-065: Project-specific branch examples in AGENTS.md and AGENT_PLAN.md

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-065
- **Found in:** `AGENTS.md` lines 338-339, `docs/AGENT_PLAN.md` line 61
- **Description:** Branch naming examples contained specific story/bug IDs (US-002-001, BUG-007, BUG-012) instead of generic placeholders.
- **Fix:** Replaced with generic placeholders (US-XXXX, BUG-XXXX).

### BUG-066: No SAST or secret scanning in CI pipeline

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-066
...
### BUG-084: Splash screen asset file missing — assets/ directory does not exist

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-084
...
### BUG-086: Search bar missing from catalog screen — AC-002-003-001 and AC-002-003-002 not implemented

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-086
- **Found in:** `app/(tabs)/catalog.tsx` — entire screen
- **Story:** US-002-003
- **AC:** AC-002-003-001, AC-002-003-002
- **TC:** TC-002-003-001, TC-002-003-002
- **Found by:** Sentinel (static analysis — test execution 2026-04-04)
- **Description:** `catalog.tsx` contains no `TextInput`, `SearchBar`, or any search UI element. The screen renders only a horizontal category chip row and a product `FlatList`. `ProductContext` exposes a `search(query)` method and `productService.search()` performs case-insensitive name/description filtering — but neither is connected to any UI. AC-002-003-001 requires a search bar visible at the top of the catalog screen; AC-002-003-002 requires real-time filtering as the user types. Both acceptance criteria are unmet.
...
### BUG-067: AC-005-003-001/AC-005-003-002 — No "I'll Get This" claim button in shared/[id].tsx

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-067
- **Found in:** `app/wishlist/shared/[id].tsx` — entire screen
- **Story:** US-005-003
- **AC:** AC-005-003-001, AC-005-003-002
- **Description:** The shared wishlist screen renders a read-only list showing "Available to claim" or "Already claimed" text but provides no interactive claim button. AC-005-003-001 requires an "I'll Get This" `TouchableOpacity` per unclaimed item. AC-005-003-002 requires that claiming persists the claimer name and disables the button for other users. Neither UI element exists; the `claimItem` context action is unused from this screen.
- **Fix:** Add a `TouchableOpacity` "I'll Get This" button to each unclaimed item row in `shared/[id].tsx`. Wire it to `claimItem(wishlistId, item.productId)` from `useWishlists()`. For claimed items, show the claimer's name (or "Someone" to preserve surprise for non-owners per AC-005-003-003) and hide/disable the button. Check if `currentUser.id === wishlist.ownerId` to suppress claimer name for the owner.
...
### BUG-068: AC-005-003-003 — Owner can infer claimed status but owner/recipient distinction not implemented

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-068
- **Found in:** `app/wishlist/shared/[id].tsx` lines 53-57
- **Story:** US-005-003
- **AC:** AC-005-003-003
- **Description:** The screen renders `item.claimedBy ? "Already claimed" : "Available to claim"` for all viewers with no distinction between the wishlist owner and a recipient. AC-005-003-003 requires that the owner cannot see who claimed which item. Currently there is no `currentUser` check against `wishlist.ownerId`; if the owner navigates to the shared view they will see claimed status the same as any recipient. Additionally, the wording "Already claimed" — though it hides the name — was not intentionally designed; it's the absence of an unimplemented feature. The fix for BUG-067 must also implement this check explicitly.
- **Fix:** In `shared/[id].tsx`, call `useAuth()` to get `currentUser`. Where `item.claimedBy !== null`, show the claimer name only if `currentUser.id !== wishlist.ownerId`. Owners see "Claimed" (no name); recipients see the claimer's name (or their own name if they claimed it). This satisfies AC-005-003-003 by design, not by accident.
...
### BUG-069: AC-004-002-001/AC-004-002-002 — wishlist/[id].tsx shows raw productIds, not names/prices; no remove action

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-069
- **Found in:** `app/wishlist/[id].tsx` lines 48-49, 65
- **Story:** US-004-002
- **AC:** AC-004-002-001, AC-004-002-002
- **Description:** The wishlist detail screen renders `Product: {item.productId}` (raw ID string) instead of resolving product name and price. AC-004-002-001 requires items show image, name, and price. The `WishlistItemRow` component exists and accepts `productName` and `productPrice` props but is never used here. Additionally, AC-004-002-002 requires a swipe-to-delete or remove button; no such control exists in the screen.
...
### BUG-070: AC-002-002-002/AC-002-002-003 — No "Add to Wishlist" button on product detail screen

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-070
- **Found in:** `app/product/[id].tsx` — entire screen
- **Story:** US-002-002
- **AC:** AC-002-002-002, AC-002-002-003
- **Description:** The product detail screen shows product info (name, price, description, stock status) but has no "Add to Wishlist" button. AC-002-002-002 requires the button to be visible and functional. AC-002-002-003 requires a wishlist picker when multiple wishlists exist, or add-to-default. The `addItem` action is available in `WishlistContext` but is not wired to this screen.
...
### BUG-071: US-003-001 scan screen is a placeholder stub — AC-003-001-001 through AC-003-001-004 not delivered

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-071
- **Found in:** `app/(tabs)/scan.tsx` — entire screen
- **Story:** US-003-001
- **AC:** AC-003-001-001, AC-003-001-002, AC-003-001-003, AC-003-001-004
- **Description:** The scan screen renders a static message "Camera integration coming in next phase." No expo-camera integration, no barcode overlay, no permission handling, and no barcode-to-product lookup are present. Prior context indicated Pixel used expo-camera with a simulator fallback (TextInput for manual barcode entry, AC-0043), but this code was not committed. All four US-003-001 acceptance criteria are unmet.
- **Fix:** Replace the stub with an expo-camera `CameraView` that scans barcodes. On a real device, use camera scanning. On simulator, show `BarcodeOverlay` and a manual TextInput fallback (AC-0043). On scan, call `getByBarcode(code)` from `useProducts()`. Navigate to `product/[barcode-product-id]` on success; show "Product not found" on failure. Request camera permission gracefully (AC-003-001-004).
...
### BUG-072: shared/[id].tsx shows raw productIds — product names and prices not resolved

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-072
- **Found in:** `app/wishlist/shared/[id].tsx` line 52
- **Story:** US-005-002
- **AC:** AC-005-002-002
- **Description:** Like `wishlist/[id].tsx`, the shared view renders `Product: {item.productId}` raw IDs. AC-005-002-002 requires shared wishlist items to show image, name, price, and claimed status. Product context is not imported and `useProducts()` is not called.
...
### BUG-073: No component tests for any screen or UI component

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** feature/BUG-073-component-tests
...
### BUG-074: No accessibility attributes on any interactive elements

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-074
- **Found in:** All components and screens — `components/`, `app/`
- **Story:** US-001-001 (design system compliance)
...
### BUG-079: Dashboard spotlight always shows Conductor because Conductor is always active

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-079
- **Found in:** `tools/generate-dashboard.js`, `docs/dashboard.html`
...
### BUG-080: Dashboard needs more dynamic visualizations for agentic activity
...
### BUG-081: PlanVisualizer not in sync with actual pipeline status

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-081
...
- **Resolution:** Fixed this session. All 6 EPICs, all 13 user stories (including US-001-001, US-001-002, US-002-003), and all 21 tasks updated to `Status: Done` in `docs/RELEASE_PLAN.md`. `parse-bugs.js` field-name mismatch corrected (`"Story"` lookup). `parse-coverage.js` fixed to use line coverage (91.68%) as primary metric. TC-001-001-004/0038/0012/0040 updated to Pass. `npm run plan:generate` now shows 6/6 epics Done, 13/13 stories Done, 40/40 TCs Pass, 91.68% coverage.

### BUG-082: Quality metrics (code coverage, tests passed) not updating during Build phase
...
### BUG-098: Dead if/else in wishlists.tsx sections builder — both branches identical

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-098
- **Found in:** `app/(tabs)/wishlists.tsx` lines 71–75
- **Story:** US-005-001 (Shared Wishlists), US-005-002 (Create Wishlist)
...
### BUG-083: Activity log timestamps use UTC offset instead of local time (EDT)

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-083
...
### BUG-077: AC-003-001-005 and AC-004-002-004 used in code but not registered in RELEASE_PLAN or ID_REGISTRY

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-077
...
- **Story:** US-003-001 (AC-003-001-005 — unique barcode lookup), US-004-002 (AC-004-002-004 — duplicate item guard)
- **Found by:** Lens (code review — feature/forge-services)
- **Description:** Forge references AC-003-001-005 (unique barcode lookup) and AC-004-002-004 (duplicate item guard) in service code comments and test annotations. However, neither AC is formally defined in `docs/RELEASE_PLAN.md` under its user story. The ID_REGISTRY still shows `AC | AC-003-001-005 | AC-006-001-004`, meaning AC-003-001-005 is "next available" — not assigned. AC-004-002-004 is entirely untracked. Any reader of the release plan cannot trace these acceptance criteria.
- **Fix:** Add AC-003-001-005 under US-003-001 in RELEASE_PLAN.md ("getByBarcode returns the matching product for a known barcode"), add AC-004-002-004 under US-004-002 ("addItem does not add a duplicate product to the wishlist"), and update ID_REGISTRY to `AC | AC-0043 | AC-004-002-004`.
- **Resolution:** AC-003-001-005 added under US-003-001 in `docs/RELEASE_PLAN.md`. AC-004-002-004 added under US-004-002. ID_REGISTRY updated: `AC | AC-0043 | AC-004-002-004`.

### BUG-078: wishlistService.removeItem missing test for empty productId guard

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-078
...
### BUG-087: Agentic dashboard resets to initial state — shows 0/6 phases, "Waiting for Conductor to activate agents"

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-087
- **Found in:** `docs/sdlc-status.json`, `tools/generate-dashboard.js`
- **Story:** N/A (tooling)
...
### BUG-089: Plan Visualizer "Cost Breakdown (Projected vs AI)" chart shows no AI Cost bars despite $299 total in header

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-089
...
### BUG-088: Agentic dashboard has structural concurrency issues — metrics lag, phase shown incorrectly, counts diverge from source files
...
### BUG-090: Missing `"main": "expo-router/entry"` in package.json — app crashed on launch with "Unable to resolve module ../../App"

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-090
- **Found in:** `package.json`
- **Story:** US-001-001
...
### BUG-091: Empty `src/app/.gitkeep` scaffold dir causes expo-router v4 to show "Welcome to Expo" onboarding instead of app routes

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-091
...
### BUG-092: Stale `Podfile.lock` pinned `React-Core-prebuilt@0.84.1` after react-native downgrade to 0.83.4 — Swift API mismatch

- **Severity:** Critical
- **Status:** Fixed
- **Fix Branch:** est/BUG-092
...
### BUG-093: Native iOS xcassets (icon and splash) not updated when `assets/` source files are changed — requires `expo prebuild` to sync

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-093
...
### BUG-094: App icon rejected by Xcode — RGBA with alpha channel and incorrect size (2048×2048 instead of 1024×1024)

- **Severity:** Major
- **Status:** Fixed
- **Fix Branch:** est/BUG-094
...
### BUG-095: Back button on Wishlist and Product Detail screens shows "(tabs)" instead of a readable label

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-095
- **Found in:** `app/_layout.tsx`
- **Story:** US-004-001, US-002-002
...
### BUG-096: Plan Visualizer Hierarchy tab column view appears empty — all epic sections start collapsed

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-096
...
### BUG-097: Plan Visualizer Costs tab "Bug Fix Costs" column view appears empty — all epic groups collapsed with bugs out of sight

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** est/BUG-097
...
## P2 — Minor (US-003-002 Simulator Scan — demo observation)

### BUG-099: Product detail screen always shows placeholder — Image never rendered

- **Severity:** Minor
- **Status:** Fixed
- **Fix Branch:** feature/US-003-002-simulator-scan-mock
...
### BUG-100: No mock "Add to Cart" button on product detail screen
...
### BUG-101: "Add to Wishlist" skipped picker when user had exactly one wishlist
...
### BUG-102: Wishlist detail screen never passed productImage prop to WishlistItemRow — always showed grey placeholder
...
### BUG-103: Wishlist total footer clipped by iPhone home indicator
...
### BUG-104: No logout/switch-user button in tab header — blocks demo user switching
...
### BUG-105: Create Wishlist modal keyboard obscures input on iOS
...
### BUG-108: Dashboard phase pipeline accumulates across sessions — misleading progress metrics
...
### BUG-107: Dashboard blinks on every auto-refresh due to full-page reload architecture
...
### BUG-109: ProductCard savedPill and savedPillText use hardcoded hex colors instead of theme tokens
...
### BUG-110: BottomSheetInput confirm button is never visually disabled when input is empty — AC-007-004-004 not met
...
- **Story:** US-007-004
- **Found by:** Lens (code review)
- **Description:** AC-007-004-004 requires the save button to be disabled when the input is empty. The component uses a `useRef` (not `useState`) to track the current value, so the component cannot reactively re-render to toggle `disabled`. The confirm `TouchableOpacity` has no `disabled` prop and no visual disabled style. The rename handler in `wishlist/[id].tsx` does guard `!newName.trim()` so data integrity is safe, but the button appears pressable even when the field is empty, which fails the acceptance criterion.
...
### BUG-111: copyLinkButton and privacy picker option/cancel TouchableOpacity elements missing accessibilityRole and accessibilityLabel (US-007-009)
...
- **Description:** Three new interactive `TouchableOpacity` elements introduced in commit 33f4489 are missing accessibility attributes:
  ...
  3. Privacy picker cancel button (line ~332) — no `accessibilityRole`.
     Per L-028 and design system rule, every `TouchableOpacity` must have `accessibilityRole="button"` and a descriptive `accessibilityLabel`. The restock and price-drop buttons in US-007-007/0023 correctly include both — this inconsistency is in the US-007-009 commit only.
...
### BUG-112: privacyOptionSubtitle uses hardcoded marginTop: 2 instead of a spacing token
...
### BUG-106: Dashboard shows no audio/notification alert when pipeline state changes — user has no signal to return to terminal
...
### BUG-113: AI Cost Timeline chart inflated by est/\* estimated bug costs — diverged from header total
...
- **Description:** `sessionTimeline` called `deduplicateSessions(costRows)` without filtering `est/*` branches. The 18 synthetic estimated-bug-cost rows (e.g. `est/BUG-001`) — representing manual estimates injected into `AI_COST_LOG.md` for bugs without real session data — were included in the cumulative timeline, inflating it by $101.15. The header total (`_totals.costUsd`) correctly skips `est/*` branches in `aggregateCostByBranch`, causing the two metrics to diverge.
...
### BUG-114: Plan Visualizer hierarchy card view renders blank — applyFilters hides all card epics on init
...
### BUG-115: Agent Status card not fixed width — overflows grid and pushes User Stories panel offscreen
