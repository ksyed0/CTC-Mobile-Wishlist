...
_Calculation: Users × (incremental AOV × transactions/year)_
...
| Benefit                            | Description                                                                                                                           |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| **First-party intent data**        | Wishlists reveal what customers _want_ (not just what they buy) — a goldmine for merchandising, assortment planning, and ad targeting |
...
_This document is a mock business plan prepared for the EPAM–CTC Hackathon POC. Revenue figures are based on publicly available CTC financial data (FY 2023–2024) and industry benchmarks. Actual results will vary based on implementation, adoption, and market conditions._
